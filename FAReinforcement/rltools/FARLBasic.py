...
class FARLBase:
    ...
    def __init__(self, Q, Environment, Action_Selector, gamma=1.0):
        ...
        x_width = 400
        y_height = 300
        self.LearningCurveGraph = canvas(x=0, y=y_height, width=2 * x_width, height=y_height,
                                         title="Learning Curve", xtitle="Episode", ytitle="Steps",
                                         xmin=0.0, ymin=0.0, foreground=color.black, background=color.white)
        # Learning Curve
        self.Lcurve = gcurve(color=color.blue)
        self.gtitle = label(pos=self.LearningCurveGraph.center, opacity=0, text="Learning Curve")
        # self.LearningCurveGraph.visible = False
    ...
    def PlotLearningCurve(self, episode, steps, epsilon):
        ...
        self.LearningCurveGraph.select()
        #self.gtitle.pos = self.LearningCurveGraph.center
